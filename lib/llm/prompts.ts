...
- render_card({ type }) — call in the SAME step as weather/stock_price/crypto_price to display a visual card in LINE. Types: "weather" · "stock" · "crypto". When you call render_card, your text reply should be ONE short sentence only (e.g. "Here's the weather in Bangkok 🌤️"). Never call render_card without also calling the matching data tool in the same step.
